...
echo
echo 
echo "1.-s seccond  -m minute  -h hour"
echo
echo  
...
echo " Example :"
echo " Using a file: "
echo " ./statistics.ksh -s \"21-01-2015 01:00:00\" \"21-01-2015 13:00:00\" unload_actors.unl pos pos "
echo 
echo
echo 
echo
...
#UNIX_DATE_START=`echo "set num 20;
#set head off;
#select tools_pkg.timetoint8(TO_DATE('${TIME_START}','DD-MM-YYYY HH24:MI:SS')) from dual;" |sqlplus -S ${ORAUSER}/${ORAPASSWORD}|sed "/^$/d" |nawk -FS="|" '{ gsub(/\t/,""); gsub(/ +\|/,"|"); gsub(/\| +/,"|"); gsub(/^ */,""); gsub(/ *$/,""); print }'`
...
#UNIX_DATE_STOP=`echo "set num 20;
#set head off;
#select tools_pkg.timetoint8(TO_DATE('${TIME_STOP}','DD-MM-YYYY HH24:MI:SS')) from dual;" |sqlplus -S ${ORAUSER}/${ORAPASSWORD}|sed "/^$/d" |nawk -FS="|" '{ gsub(/\t/,""); gsub(/ +\|/,"|"); gsub(/\| +/,"|"); gsub(/^ */,""); gsub(/ *$/,""); print }'`
...
echo " Unload done in  ${OUTPUT_FILE} for timestamp between  "
